 ...
 public function __construct()
  {
    ...
    public function download($file_name) {
      $file = config('laravel-backup.backup.name') .'/Galaxy/'. $file_name;
      $disk = Storage::disk(config('laravel-backup.backup.destination.disks'));
    ...
    public function delete($file_name){
      $disk = Storage::disk(config('laravel-backup.backup.destination.disks'));
      if ($disk->exists(config('laravel-backup.backup.name') . '/Galaxy/' . $file_name)) {
       $disk->delete(config('laravel-backup.backup.name') . '/Galaxy/' . $file_name);
