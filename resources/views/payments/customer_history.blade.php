                                    ...
                                    <tbody>
                                        @foreach ($statements as $key => $state)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $state->to_id }}</td>
                                                <td>{{ $state->payment_date }} {{ $state->payment_time }}</td>
                                                <td>{{ $state->remarks }}</td>
                                                <td>{{ $state->old_balance }}</td>
                                                @if($state->transaction_type == 1)
                                                <td class="text-success">+ {{ $state->pay_amount }}</td>
                                                @else
                                                <td class="text-danger">- {{ $state->pay_amount }}</td>
