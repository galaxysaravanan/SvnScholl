                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-sm btn-secondary float-right" data-toggle="modal"
                            data-target="#addclass"><i class="fa fa-plus"> </i> Add Timetable</button>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($timetable as $t)
                                        <tr>
                                            ...
                                            <td width="10" style="white-space: nowrap">
                                                <a onclick="edit_subject('{{ $t->id }}','{{ $t->subject_name }}','{{ $t->name }}')"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label for="class" class="col-sm-4 col-form-label"><span
                                                                style="color:red">*</span>Class</label>
                                                        <div class="col-sm-8">
                                                            <select name="class_id" class="form-control" id="class">
                                                                <option value="">Select Class</option>
                                                                @foreach ($class as $clas)
                                                                    <option
                                                                        value="{{ $clas->id }} ~ {{ $clas->division_id }}">
                                                                        {{ $clas->class_name }} {{ $clas->division_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="subject" class="col-sm-4 col-form-label"><span
                                                                style="color:red">*</span>Subject Name</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="Weekday" class="col-sm-4 col-form-label"><span
                                                                style="color:red">*</span>Weekday</label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="name" class="col-sm-4 col-form-label"><span
                                                                style="color:red">*</span>Period</label>
                                                        <div class="col-sm-8">
                                                            <select name="period_id" class="form-control" id="period">
                                                                <option value="">Select Period</option>
                                                                @foreach ($period as $per)
                                                                    <option value="{{ $per->id }}">
                                                                        {{ $per->period_name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staff" class="col-sm-4 col-form-label"><span
                                                                style="color:red">*</span>Staff</label>
                                                        <div class="col-sm-8">
                        ...
                        <div class="modal fade" id="editstaff" tabindex="-1" aria-hidden="true">
                            <form action="{{ url('/updatesub') }}" method="post">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalScrollable">Update Staff</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="hidden" name="svn_id" id="svn_id">
                                                    <div class="form-group row">
                                                        <label for="subject_id" class="col-sm-4 col-form-label"><span
                                                                style="color:red">*</span>Subject</label>
                                                        <div class="col-sm-8">
                                                            <select required="required" name="subject_id"
                                                                class="form-control select2" id="editsubject">
                                                                <option value="">Select Subject</option>
                                                                @foreach ($subject as $s)
                                                                    <option
                                                                        @if ($t->subject_id == $s->id) selected @endif
                                                                        value="{{ $s->id }}">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="staff_id" class="col-sm-4 col-form-label"><span
                                                                style="color:red">*</span>Staff</label>
                                                        <div class="col-sm-8">
                                                            <select required="required" name="staff_id"
                                                                class="form-control select2" id="editname">
                                                                <option value="">Select Subject</option>
                                                                @foreach ($users as $user)
                                                                    <option
                                                                        @if ($t->staff_id == $user->id) selected @endif
...
@push('page_scripts')
    <script>
        ...
        // function edit_subject(id, subject_name, name) {
        //     $("#svn_id").val(id);
        //     $("#editsubject").val(subject_name);
        //     $("#editname").val(name);
