...
<a href="#" class="small-box-footer">More info <i class="fas fa-eye"></i></a>
</div>
</div>
...
<a class="nav-link active" id="vert-tabs-home-tab" data-toggle="pill" href="#vert-tabs-home" role="tab" aria-controls="vert-tabs-home" aria-selected="true">{{ $accounttypelist->name }}</a>
 @endforeach
</div>
</div>
